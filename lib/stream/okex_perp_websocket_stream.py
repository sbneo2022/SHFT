...
WS_FUNDING_RATE = 'swap/funding_rate'
WS_BOOK = 'swap/ticker'
WS_TRADES = 'swap/trade'
WS_LEVEL = 'swap/depth5'
WS_KLINES = 'swap/candle60s'
WS_POSITION = 'swap/position'
WS_ORDER = 'swap/order'
WS_ACCOUNT = 'swap/account'
...
class OkexPerpWebsocketStream(AbstractStream):
